...
describe('InactiveUsers ', function () {
  it('shows an empty list', () => {
    const result = shallow(<InactiveUsers webId={literal('https://uo225211.solidcommunity.net//profile/card#me')}/>);
...
describe('DeleteUsers ', function () {
  ...
  it('can render and update a counter', () => {
    ...
    act(() => {    ReactDOM.render(<InactiveUsers webId={literal('https://asw2021es1b.solidcommunity.net/profile/card#me')}/>, container)});
